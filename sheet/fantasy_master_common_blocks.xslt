...
<xsl:stylesheet version="1.0"
  ...
  <xsl:import href="blocks/block_attack.xslt"/>
  <xsl:import href="blocks/block_bio_condensed.xslt"/>
  <xsl:import href="blocks/block_class_features.xslt"/>
  <xsl:import href="blocks/block_equipment.xslt"/>
  <xsl:import href="blocks/block_features.xslt"/>
  <xsl:import href="blocks/block_hp_defense.xslt"/>
  <xsl:import href="blocks/block_misc.xslt"/>
  <xsl:import href="blocks/block_pc_header_row.xslt"/>
  <xsl:import href="blocks/block_protection.xslt"/>
  <xsl:import href="blocks/block_psionics.xslt"/>
  <xsl:import href="blocks/block_skills.xslt"/>
  <xsl:import href="blocks/block_spells_condensed.xslt"/>
  <xsl:import href="blocks/block_stat_block.xslt"/>
  <xsl:import href="blocks/block_weapons.xslt"/>
  <!-- END -->
      ...
      <fo:table-body>
        <fo:table-row keep-with-next="always" keep-together="always">
          ...
          <fo:table-cell text-align="center" wrap-option="no-wrap" border-top-color="black" border-top-style="solid" border-top-width="0.1pt" background-color="transparent" padding-top="2pt">
            <fo:block text-align="center" font-size="5pt">PCGen Character Template by tcrawley, based on work by Frugal, ROG, Arcady, Barak, Dimrill, Dekker &amp; Andrew Maitland (LegacyKing).</fo:block>
      ...
      <fo:page-sequence>
        ...
        <fo:flow flow-name="body" font-size="8pt">
          ...
          <fo:block span="all">
            <fo:table table-layout="fixed">
              <fo:table-column>
                <xsl:attribute name="column-width"><xsl:value-of select="0.15 * $pagePrintableWidth" />mm</xsl:attribute>
              </fo:table-column>
              <fo:table-column>
                <xsl:attribute name="column-width"><xsl:value-of select="0.14 * $pagePrintableWidth" />mm</xsl:attribute>
              </fo:table-column>
              <fo:table-column>
