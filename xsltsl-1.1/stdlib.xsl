...
<xsl:template match="foo">
  <xsl:call-template name="str:subst">
    ...
    <chapter>
      ...
      <para>Each module is allocated a namespace URI by appending the module name to the URI for the project, http://xsltsl.sourceforge.net.  For example, the string module has the namespace URI http://xsltsl.sourceforge.net/string.html.</para>
      <para>All documentation is written using an <ulink url="docbook-extensions.html">extension</ulink> of <ulink url="http://www.docbook.org/">DocBook</ulink> designed for <ulink url="docbook-extensions.html">embedding DocBook into XSLT stylesheets</ulink>.  The namespace URI for DocBook embedded in stylesheets is http://xsltsl.sourceforge.net</para>
    </chapter>
